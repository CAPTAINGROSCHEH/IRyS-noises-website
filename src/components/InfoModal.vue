    ...
    <div class="modal-overlay" @click="$emit('close-modal')" >
        <div class="modal" @click.stop>
            ...
            <div class="modal-body">
                ...
                <p>There's currently 2645 sounds! You can find the audios that were added during each update <a href="https://github.com/CAPTAINGROSCHEH/IRyS-noises-website/tree/main/src/assets/UpdateLogs" >here</a>! </p>
            </div>
        </div>
    </div>
</template>
